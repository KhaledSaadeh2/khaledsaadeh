...
public class AdminDashboardTest {
	...
	public AdminDashboardTest() {
		...
		admin = new Admin("khaledsholi@gmail.com", "khaled2001", "Admin");
		adminDashboard.addUser(new Customer("haya@gmail.com", "drhaya123", "Customer"));
		adminDashboard.addUser(admin);
		adminDashboard.addUser(new Customer("obada@gmail.com", "obada1234", "Installer"));
		...
		InstallationRequest installationRequest1 = new InstallationRequest("10-12-2023",
				new Installer("obada@gmail.com", "obada1234", "Installer"),
				new Customer("haya@gmail.com", "drhaya123", "Customer"), carAudio.getAllProducts(),
...
public void the_admin_is_signed_in() {
    ...
    int index  = adminDashboard.authenticateUser("khaledsholi@gmail.com", "khaled2001");
